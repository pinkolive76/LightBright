...
// Brigit's shoes: 39 LEDs total, 20 LEDs along the outside, LED #9 at heel, LED #29 at toe.
#define N_LEDS        39 // TOTAL number of LEDs in strip
#define HALF_STRIP    20 // cieling(N_LEDS/2), only used for LED animation logic
#define HEEL           9 // Index of REAR-MOST LED on shoe (remember, the first LED is #0)
#define TOE           29 // Index of TOP-MOST LED on shoe
